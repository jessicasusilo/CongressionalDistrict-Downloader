...
$target_path = "Data"
Get-Manifest -ProductName "zi_cdd" -TargetDirectory $target_path

# Concise Format Version
$target_path = "Data"
Get-Manifest -ProductName "zi_cddcf" -TargetDirectory $target_path

# Congressional District-ZIP Code Database 
$target_path = "Data"
Get-Manifest -ProductName "zi_cdz" -TargetDirectory $target_path